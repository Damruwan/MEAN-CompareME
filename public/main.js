...
/* harmony import */ var _components_manage_phone_manage_phone_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/manage-phone/manage-phone.component */ "./src/app/components/manage-phone/manage-phone.component.ts");
/* harmony import */ var _components_view_phone_view_phone_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/view-phone/view-phone.component */ "./src/app/components/view-phone/view-phone.component.ts");
...
/* harmony import */ var _services_phone_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./services/phone.service */ "./src/app/services/phone.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var applicationRoutes = [
    ...
    { path: 'managePhone', component: _components_manage_phone_manage_phone_component__WEBPACK_IMPORTED_MODULE_16__["ManagePhoneComponent"] },
    { path: 'viewPhone', component: _components_view_phone_view_phone_component__WEBPACK_IMPORTED_MODULE_17__["ViewPhoneComponent"] }
];
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_manage_phone_manage_phone_component__WEBPACK_IMPORTED_MODULE_16__["ManagePhoneComponent"],
                _components_view_phone_view_phone_component__WEBPACK_IMPORTED_MODULE_17__["ViewPhoneComponent"],
            ],
            imports: [
            ...
            providers: [_services_auth_service__WEBPACK_IMPORTED_MODULE_18__["AuthService"], angular2_flash_messages__WEBPACK_IMPORTED_MODULE_5__["FlashMessagesService"], _services_phone_service__WEBPACK_IMPORTED_MODULE_19__["PhoneService"]],
...
/***/ "./src/app/components/manage-phone/manage-phone.component.css":
/*!********************************************************************!*\
  !*** ./src/app/components/manage-phone/manage-phone.component.css ***!
  \********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/manage-phone/manage-phone.component.html":
/*!*********************************************************************!*\
  !*** ./src/app/components/manage-phone/manage-phone.component.html ***!
  \*********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/manage-phone/manage-phone.component.ts":
/*!*******************************************************************!*\
  !*** ./src/app/components/manage-phone/manage-phone.component.ts ***!
  \*******************************************************************/
/*! exports provided: ManagePhoneComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ManagePhoneComponent", function() { return ManagePhoneComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_phone_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/phone.service */ "./src/app/services/phone.service.ts");
/* harmony import */ var angular2_flash_messages__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! angular2-flash-messages */ "./node_modules/angular2-flash-messages/module/index.js");
/* harmony import */ var angular2_flash_messages__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(angular2_flash_messages__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
var ManagePhoneComponent = /** @class */ (function () {
    function ManagePhoneComponent(phoneService, flashMessage, router) {
        this.phoneService = phoneService;
        this.flashMessage = flashMessage;
        this.router = router;
    }
    ManagePhoneComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.phoneService.getPhone().subscribe(function (phone) {
            _this.phones = phone;
        });
    };
    ManagePhoneComponent.prototype.addPhone = function () {
        var _this = this;
        var phone = {
        ...
        this.phoneService.addPhone(phone).subscribe(function (phone) {
            _this.phones.push(phone);
            _this.phoneService.getPhone().subscribe(function (phone) {
                _this.phones = phone;
            });
        });
    };
    ManagePhoneComponent.prototype.deletePhone = function (id) {
        var phone = this.phones;
        this.phoneService.deletePhone(id).subscribe(function (data) {
            if (data.n == 1) {
    ...
    ManagePhoneComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-manage-phone',
            template: __webpack_require__(/*! ./manage-phone.component.html */ "./src/app/components/manage-phone/manage-phone.component.html"),
            styles: [__webpack_require__(/*! ./manage-phone.component.css */ "./src/app/components/manage-phone/manage-phone.component.css")]
        }),
        __metadata("design:paramtypes", [_services_phone_service__WEBPACK_IMPORTED_MODULE_1__["PhoneService"],
            angular2_flash_messages__WEBPACK_IMPORTED_MODULE_2__["FlashMessagesService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], ManagePhoneComponent);
    return ManagePhoneComponent;
}());
...
var PhoneComponent = /** @class */ (function () {
    function PhoneComponent(phoneService, router) {
        this.phoneService = phoneService;
        this.router = router;
    }
    ...
    PhoneComponent.prototype.viewPhone = function (id) {
...
/***/ "./src/app/components/view-phone/view-phone.component.css":
/*!****************************************************************!*\
  !*** ./src/app/components/view-phone/view-phone.component.css ***!
  \****************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/view-phone/view-phone.component.html":
/*!*****************************************************************!*\
  !*** ./src/app/components/view-phone/view-phone.component.html ***!
  \*****************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/view-phone/view-phone.component.ts":
/*!***************************************************************!*\
  !*** ./src/app/components/view-phone/view-phone.component.ts ***!
  \***************************************************************/
/*! exports provided: ViewPhoneComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewPhoneComponent", function() { return ViewPhoneComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_phone_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/phone.service */ "./src/app/services/phone.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
var ViewPhoneComponent = /** @class */ (function () {
    function ViewPhoneComponent(phoneService, route) {
        var _this = this;
        this.phoneService = phoneService;
        this.route = route;
        this.route.queryParams.subscribe(function (params) {
            _this.id = params["phone_id"];
        });
    }
    ViewPhoneComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.phoneService.viewPhone(this.id).subscribe(function (phone) {
            _this.phone = phone;
        });
    };
    ViewPhoneComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-view-phone',
            template: __webpack_require__(/*! ./view-phone.component.html */ "./src/app/components/view-phone/view-phone.component.html"),
            styles: [__webpack_require__(/*! ./view-phone.component.css */ "./src/app/components/view-phone/view-phone.component.css")]
        }),
        __metadata("design:paramtypes", [_services_phone_service__WEBPACK_IMPORTED_MODULE_1__["PhoneService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])
    ], ViewPhoneComponent);
    return ViewPhoneComponent;
}());
...
var PhoneService = /** @class */ (function () {
    function PhoneService(http, router) {
        this.http = http;
        this.router = router;
    }
    PhoneService.prototype.addPhone = function (phone) {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post("http://localhost:3000/phone/managePhone", phone, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) { return res.json(); }));
    };
    PhoneService.prototype.getPhone = function () {
        return this.http.get('http://localhost:3000/phone/managephone').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) { return res.json(); }));
    };
...
module.exports = __webpack_require__(/*! C:\Users\Sahan\Desktop\compareME\Angular-Front\src\main.ts */"./src/main.ts");
